...
namespace HVTradingBot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924182604_InitialCreate")]
            ...
            modelBuilder.Entity("HVTradingBot.Infrastructure.Persistence.Entities.OrderEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_paper_orders");

                    b.HasIndex("ClientOrderId")
                        .IsUnique()
                        .HasDatabaseName("ix_paper_orders_client_order_id");
            ...
            modelBuilder.Entity("HVTradingBot.Infrastructure.Persistence.Entities.PositionEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_paper_positions");

                    b.HasIndex("ClientOrderId")
                        .IsUnique()
                        .HasDatabaseName("ix_paper_positions_client_order_id");

                    b.HasIndex("ClosedAtUtc")
                        .HasDatabaseName("ix_paper_positions_closed_at_utc");

                    b.HasIndex("IsOpen")
                        .HasDatabaseName("ix_paper_positions_is_open");
