...
public sealed class PostgresFixture : IAsyncLifetime
{
    ...
    public async Task ResetAsync()
    {
        ...
        await db.Database.ExecuteSqlRawAsync(
            "TRUNCATE orders, positions, paper_accounts, broker_accounts, broker_settings, broker_connection_status, market_selection, system_state, audit_logs, trade_decisions;");
    }
