...
/**
 * Asks charts to reload their candles. The Android app has no SignalR connection; it calls this when a new bar has
 * been processed, so charts stay current there too.
 */
